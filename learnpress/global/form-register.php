 ...
 *
 * This template can be overridden by copying it to edali/learnpress/global/form-register.php.
 *
 * @author   ThimPress
...
<div class="col-lg-6">
    <div class="learn-press-form-register learn-press-form">
        ...
        <h3><?php echo _x( 'Register', 'register-heading', 'edali' ); ?></h3>
        ...
        <form name="learn-press-register" method="post" action="">
            ...
            <p>
                ...
                <button type="submit"><?php _e( 'Register', 'edali' ); ?></button>
            </p>
