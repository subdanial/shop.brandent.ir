 ...
 *
 * This template can be overridden by copying it to edali/learnpress/checkout/review-order.php.
 *
 * @author  ThimPress
...
<div class="table-responsive">
    <table class="learn-press-checkout-review-order-table lp-list-table">
        ...
        <tr>
            ...
            <th class="course-name"><?php _e( 'Course', 'edali' ); ?></th>
            <th class="course-total"><?php _e( 'Total', 'edali' ); ?></th>
