 ...
 *
 * This template can be overridden by copying it to edali/learnpress/tabs/quizzes.php.
 *
 * @author   ThimPress
...
<div class="learn-press-subtab-content">
    <h3 class="profile-heading"><?php _e( 'My Quizzes', 'edali' ); ?></h3>
            ...
            <table class="lp-list-table profile-list-quizzes profile-list-table">
                <thead>
                    <tr>
                        ...
                        <th class="column-quiz"><?php _e( 'Quiz', 'edali' ); ?></th>
                        <th class="column-date"><?php _e( 'Date', 'edali' ); ?></th>
                        <th class="column-status"><?php _e( 'Progress', 'edali' ); ?></th>
                        <th class="column-time-interval"><?php _e( 'Interval', 'edali' ); ?></th>
                    </tr>
                </thead>
                <tbody>
	...
	<?php } else { ?>
		<?php learn_press_display_message( __( 'No quizzes!', 'edali' ) ); ?>
	<?php } ?>
</div>
