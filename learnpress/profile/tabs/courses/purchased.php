 ...
 *
 * This template can be overridden by copying it to edali/learnpress/courses/purchased.php.
 *
 * @author   ThimPress
...
<div class="learn-press-subtab-content">
    ...
    <h3 class="profile-heading"><?php _e( 'Purchased Courses', 'edali' ); ?></h3>
    <a href="http://localhost/my-account/" class="back-to-acc text-orange btn btn-outline-orange">بازگشت به حساب</a>
	...
	<?php if ( $query['items'] ) { ?>
        <div class="table-responsive">
            <table class="lp-list-table profile-list-courses profile-list-table">
                <thead>
                    <tr>
                        <th class="column-course"><?php _e( 'Course', 'edali' ); ?></th>
                        <th class="column-date"><?php _e( 'Date', 'edali' ); ?></th>
                        <th class="column-passing-grade"><?php _e( 'Passing Grade', 'edali' ); ?></th>
                        <th class="column-status"><?php _e( 'Progress', 'edali' ); ?></th>
                    </tr>
                </thead>
                <tbody>
	...
	<?php } else {
		learn_press_display_message( __( 'No courses!', 'edali' ) );
	} ?>
</div>
