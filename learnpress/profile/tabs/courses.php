 ...
 *
 * This template can be overridden by copying it to edali/learnpress/tabs/courses.php.
 *
 * @author  ThimPress
...
if ( ! $query['total'] ) {
	learn_press_display_message( __( 'You haven\'t got any courses yet!', 'edali' ) );

	return;
} ?>

<div class="learn-press-subtab-content">
    <h3 class="profile-heading"><?php _e( 'My Courses', 'edali' ); ?></h3>
