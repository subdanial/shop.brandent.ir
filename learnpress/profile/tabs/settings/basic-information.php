 ...
 *
 * This template can be overridden by copying it to edali/learnpress/settings/tabs/basic-information.php.
 *
 * @author  ThimPress
...
<form method="post" id="learn-press-profile-basic-information" name="profile-basic-information"
    ...
    <ul class="form-fields">
        ...
        <li class="form-field">
            <label for="description"><?php _e( 'Biographical Info', 'edali' ); ?></label>
            <div class="form-field-input">
                <textarea name="description" id="description" rows="5"
                          cols="30"><?php esc_html( $user->get_data( 'description' ) ); ?></textarea>
                <p class="description"><?php _e( 'Share a little biographical information to fill out your profile. This may be shown publicly.', 'edali' ); ?></p>
            </div>
        </li>
        <li class="form-field">
            <label for="first_name"><?php _e( 'First Name', 'edali' ); ?></label>
            <div class="form-field-input">
        ...
        <li class="form-field">
            <label for="last_name"><?php _e( 'Last Name', 'edali' ); ?></label>
            <div class="form-field-input">
        ...
        <li class="form-field">
            <label for="nickname"><?php _e( 'Nickname', 'edali' ); ?></label>
            <div class="form-field-input">
        ...
        <li class="form-field">
            <label for="display_name"><?php _e( 'Display name publicly as', 'edali' ); ?></label>
            <div class="form-field-input">
    ...
    <button type="submit" name="submit"><?php _e( 'Save changes', 'edali' ); ?></button>
