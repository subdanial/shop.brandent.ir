 ...
 *
 * This template can be overridden by copying it to edali/learnpress/settings/tabs/avatar.php.
 *
 * @author   ThimPress
...
<form name="profile-avatar" method="post" enctype="multipart/form-data">
    ...
    <div id="lp-user-edit-avatar" class="lp-edit-profile lp-edit-avatar">
        ...
        <p id="lp-avatar-actions">
            <button id="lp-upload-photo" type="button"><?php _e( 'Upload', 'edali' ); ?></button>
			<?php if ( $custom_img != '' ): ?>
                <button id="lp-remove-upload-photo"><?php _e( 'Remove', 'edali' ); ?></button>
			<?php endif; ?>
        </p>
    </div>
    ...
    <button type="submit" id="submit" name="submit"><?php _e( 'Save changes', 'edali' ); ?></button>
